# require 'pry'
require 'yaml'
Puppet::Type.type(:gitlab_token).provide(:token_file) do
  desc 'Gitlab token generation using existing root token, stored in /etc/gitlab/root_api_token'

  confine exists: '/etc/gitlab/root_api_token'
